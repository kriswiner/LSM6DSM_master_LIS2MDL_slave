...
//LSM6DSM definitions
#define LSM6DSM1_intPin1 5  // LSM6DSM1 INT1 pin definitions 
#define LSM6DSM2_intPin1 4  // LSM6DSM2 INT1 pin definitions 
...
void setup() {
  ...
  {
   Serial.println("LSM6DSM1 and LIS2MDL1 are online..."); Serial.println(" ");
   Serial.println(" ");
